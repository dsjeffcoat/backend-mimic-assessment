...
__author__ = "Diarte Jeffcoat w/ help from Group Session with Daniel Lomelino on 06/03/20"
...
def print_mimic(mimic_dict, start_word):
    ...
    for i in range(200):
        ...
        baseword = mimic_dict.get(start_word)
        if not baseword:
            baseword = mimic_dict['']
        start_word = random.choice(baseword)
